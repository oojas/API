...
func GetSubjectChannels() []channels.ComputerSubjects {
	sub := []channels.ComputerSubjects{
		{"Kahn Academy", imageProcessing.ImageToBase64("images/khan.png"), "Khan Academy is a not-for-profit educational organization started by Salman Khan in 2008.Their mission is to provide a free, world-class education to anyone, anywhere.", "https://www.khanacademy.org/computing/computer-science"},
